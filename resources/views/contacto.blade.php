...
@section('styles')
    <link rel="stylesheet" href="{{ secure_asset('css/contacto.css') }}">
@endsection
@section('content')
    <div class="contact-container">
        ...
        <div class="form-section">
            ...
            <p class="form-description">Estamos aquí para responder tus preguntas y escuchar tus ideas para un futuro más verde.</p>
