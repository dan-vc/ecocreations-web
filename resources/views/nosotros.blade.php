    ...
    <section id="hero">
        <article class="container">
            <section class="content">
                ...
                <p>En Ecocreations S.A.C., nos dedicamos a ofrecer productos innovadores y de alta calidad, elaborados a partir de materiales reciclados. Entendemos la importancia de un consumo responsable y un futuro más verde, por lo que transformamos residuos en soluciones prácticas y con estilo, como tápers, bolsas, termos, botellas y recipientes únicos.
                </p>
                <div class="botones">
